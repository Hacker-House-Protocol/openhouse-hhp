...
> 📦 **Buildathon submission — final snapshot.** Active development and all new
> updates continue on **Phase 2 → https://github.com/dexalien/hhp-phase2** — follow that repo for the latest.
